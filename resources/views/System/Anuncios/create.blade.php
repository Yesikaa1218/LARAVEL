...
@section('page_name', 'Registrar aviso')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Registrar Aviso</h1>
...
@section('content')
    <div class="container-fluid">
        <form action="{{route('sistema.avisos.store')}}" method="post"  enctype="multipart/form-data">
            @csrf
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Registrar Aviso</h6>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-sm-12 col-mb-6 col-xl-6">
                            ...
                            <input type="date" class="form-control" id="fecha_inicio" value="{{old('fecha_inicio')}}" name="fecha_inicio" placeholder="Fecha de Inicio del Aviso" required>
                        </div>


                        <div class="mb-3 col-sm-12 col-mb-6 col-xl-6">
                            <label for="fehca_final" class="form-label">Fecha Final del Aviso</label>
                            <input type="date" class="form-control" id="fehca_final" value="{{old('fehca_final')}}" name="fehca_final" placeholder="Fecha Final del Aviso" required>
                        </div>
                        ...
                        <div class="mb-3 col-sm-12 col-mb-6 col-xl-6">
                            ...
                            <input type="file" class="form-control" id="imagen" value="{{old('imagen')}}" accept=".jpg,.png" name="imagen" placeholder="Imagen del Aviso" required>
                    ...
                    <div class="mb-3 col-sm-12">
                        ...
                        <textarea name="contenido" class="content_page" id="contenido" rows="4" placeholder="Contenido del Aviso">{{old('contenido')}}</textarea>
                    </div>

                    <div>
                        <input name="user_id" id="user_id" value="{{\Illuminate\Support\Facades\Auth::user()->id}}" readonly type="hidden">
                    </div>

                    <div class="mb-3 col-sm-12">
                        <label class="form-label">¿Mostrar aviso al inicio de la página?: </label>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="mostrarInicio" id="mostrar" value="on" {{ old('mostrarInicio') == 'on' ? 'selected' : '' }}>
                            <label class="form-check-label" for="mostrar">
                                Sí
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="mostrarInicio" id="noMostrar" value="off" {{ old('mostrarInicio') == 'off' ? 'selected' : '' }}>
