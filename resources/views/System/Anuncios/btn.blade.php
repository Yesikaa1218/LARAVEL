...
@IF($active == 0)
<form
    action="{{route('sistema.avisos.approve', $id)}}"
...
<a href="{{route('sistema.avisos.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.avisos.destroy', ['aviso' => $id])}}"
