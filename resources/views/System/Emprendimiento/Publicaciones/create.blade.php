...
@section('page_name', 'Registrar Publicación de Emprendedores')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Registrar Publicación de Emprendedores</h1>
...
@section('content')
    <div class="container-fluid">
        <form action="{{route('sistema.emprendimiento.publicaciones.store')}}" method="post"  enctype="multipart/form-data">
        @csrf
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Registrar Publicación de Emprendedores</h6>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-sm-12 ">
                        ...
                        <textarea name="contenido" class="content_page" id="contenido" rows="4" placeholder="Contenido de la Publicación">{{old('contenido')}}</textarea>
                    </div>
