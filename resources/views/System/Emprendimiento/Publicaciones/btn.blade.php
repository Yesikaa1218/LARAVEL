...
@if($active == 0)
<form
    action="{{route('sistema.emprendimiento.publicaciones.approve', $id)}}"
...
@endif
@endhasanyrole
<a href="{{route('sistema.emprendimiento.publicaciones.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.emprendimiento.publicaciones.destroy', ['publicacione' => $id])}}"
