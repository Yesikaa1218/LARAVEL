...
@section('page_name', 'Registrar Proyecto de Emprendedores')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Registrar Proyecto de Emprendedores</h1>
...
@section('content')
    <div class="container-fluid">
        <form action="{{route('sistema.emprendimiento.proyectos.store')}}" method="post"  enctype="multipart/form-data">
        @csrf
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Registrar Proyecto de Emprendedores</h6>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="mb-3 col-sm-12 col-mb-6 col-xl-6">
                        ...
                        <input type="text" class="form-control" id="nombre" value="{{old('nombre')}}" name="nombre" placeholder="Nombre del proyecto" required>
                    </div>
                    ...
                    <div class="mb-3 col-sm-12 col-mb-6 col-xl-6">
                        ...
                        <input type="text" class="form-control" name="estatus" value="{{old('estatus')}}" id="estatus" placeholder="Estatus" required>
                    </div>
                    <br>

                    <div class="mb-3 col-sm-12 ">
                        <label for="descripcion" class="form-label">Descripción del proyecto</label>
                        <textarea name="descripcion" class="content_page" id="descripcion" rows="4" placeholder="Descripción del proyecto">{{old('descripcion')}}</textarea>
                    </div>
