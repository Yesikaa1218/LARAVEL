...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Guia EXEN</h1>
    </div>
@endsection
        ...
        <div class="card shadow mb-4">
            ...
            <form id="content_form" method="post">
                ...
                <div class="card-footer" align="right">
                    ...
                    <a href="{{route('sistema.preview.guia-exens.show')}}" class="btn btn-light" target="_blank">Ver preview</a>

                    @hasanyrole('SuperAdmin')
                        @if($data && $data->active === 0)
                        <form
                            action="{{route('sistema.guia-exens.approve', $data->id)}}"
...
@section('scripts-page')
    ...
    <script>
        ...
        var _url = "{{ route('sistema.guia-exens.store', $data->id) }}";
        var _return = "{{ route('sistema.guia-exens.index') }}";
    </script>
