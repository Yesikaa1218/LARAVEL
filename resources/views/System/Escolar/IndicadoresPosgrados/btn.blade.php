...
@if($active == 0)
<form
    action="{{route('sistema.escolar.indicadores.posgrados.approve', $id)}}"
...
<a href="{{route('sistema.escolar.indicadores.posgrados.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.escolar.indicadores.posgrados.destroy', ['indicadores_posgrado' => $id])}}"
