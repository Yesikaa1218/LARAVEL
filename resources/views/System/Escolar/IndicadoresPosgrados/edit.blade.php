...
@section('page_name', 'Editar Indicador de Posgrado')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Editar Indicador de Posgrado</h1>
...
@section('content')
    <div class="container-fluid">
        <form action="{{route('sistema.escolar.indicadores.posgrados.update',  ['indicadores_posgrado' => $data->id])}}" method="post" enctype="multipart/form-data">
        @csrf
            @method('PATCH')
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Editar Indicador de Posgrado</h6>
            </div>
