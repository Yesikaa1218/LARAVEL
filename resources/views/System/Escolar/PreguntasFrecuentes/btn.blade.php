...
@if($active === 0)
<form
    action="{{route('sistema.escolar.preguntas.approve', $id)}}"
...
<a href="{{route('sistema.escolar.preguntas.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.escolar.preguntas.destroy', ['pregunta' => $id])}}"
