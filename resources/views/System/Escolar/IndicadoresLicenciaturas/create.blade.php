...
@section('page_name', 'Registrar Indicador de Licenciatura')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Registrar Indicador de Licenciatura</h1>
        <a href="{{route('sistema.escolar.indicadores.licenciaturas.index')}}" class="d-none d-sm-inline-block btn  btn-primary shadow-sm"><i
...
@section('content')
    <div class="container-fluid">
        <form action="{{route('sistema.escolar.indicadores.licenciaturas.store')}}" method="post" enctype="multipart/form-data">
        @csrf
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Registrar Indicador de Licenciatura</h6>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-sm-12 col-mb-6 col-xl-6">
                        ...
                        <select class="form-control" name="licenciatura_id" id="licenciatura_id" required>
                        <option selected  hidden disabled  value>Seleccione una licenciatura</option>
