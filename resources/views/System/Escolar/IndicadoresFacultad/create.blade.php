...
@section('page_name', 'Registrar Indicador de la Facultad')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Registrar Indicador de la Facultad</h1>
...
@section('content')
    <div class="container-fluid">
        <form action="{{route('sistema.escolar.indicadores.facultad.store')}}" method="post" enctype="multipart/form-data">
        @csrf
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Registrar Indicador de Facultad</h6>
            </div>
