...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Escolar</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <form action="{{route('sistema.escolar.store')}}" method="post">
                @csrf
                ...
                <div class="card-footer" align="right">
                    ...
                    @hasanyrole('SuperAdmin')
                        @if($data && $data->active === 0)
                            <form
                            action="{{route('sistema.escolar.approve', $data->id)}}"
                    ...
                    @endhasanyrole
                    <!-- end boton aprobar -->  
                    <a href="{{route('sistema.preview.escolar.show')}}" class="btn btn-light" target="_blank">Ver preview</a>
