...
@IF($active == 0)
<form
    action="{{route('sistema.noticias.categorias.approve', $id)}}"
...
<a href="{{route('sistema.noticias.categorias.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.noticias.categorias.destroy', ['noticias_categoria' => $id])}}"
