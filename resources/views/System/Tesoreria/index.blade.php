...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tesorería</h1>
    </div>
@endsection
...
@endif
        ...
        <div class="card shadow mb-4">
            ...
            <form action="{{route('sistema.tesoreria.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-body">
                    ...
                    <label for="calendario_pagos_posgrado" class="form-label">Calendario de pagos de posgrado <small>(Opcional)</small></label>
                    <small>*Máximo 4MB</small>
                    <input type="file" class="form-control-file form-control" name="calendario_pagos_posgrado" id="calendario_pagos_posgrado" accept=".pdf">

                    <br>

                    <label for="manual_cuota_interna" class="form-label">Manual para cuota interna <small>(Opcional)</small></label>
                    <small>*Máximo 4MB</small>
                    <input type="file" class="form-control-file form-control" name="manual_cuota_interna" id="manual_cuota_interna" accept=".pdf">

                    <br>
                    
                    <label for="solicitud_factura" class="form-label">Solicitud de factura <small>(Opcional)</small></label>
                    <small>*Máximo 4MB</small>
                    <input type="file" class="form-control-file form-control" name="solicitud_factura" id="solicitud_factura" accept=".pdf">
                ...
                <div class="card-footer" align="right">
                    ...
                    <a href="{{route('sistema.preview.tesoreria.show')}}" class="btn btn-light" target="_blank">Ver preview</a>

                    @hasanyrole('SuperAdmin')
                        @if($data && $data->active === 0)
                        <form
                            action="{{route('sistema.tesoreria.approve', $data->id)}}"
