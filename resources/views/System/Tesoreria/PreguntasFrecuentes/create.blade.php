...
@section('page_name', 'Registrar Pregunta Frecuente')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Registrar Pregunta Frecuente</h1>
...
@section('content')
    <div class="container-fluid">
        <form action="{{route('sistema.tesoreria.preguntas.store')}}" method="post">
        @csrf
        <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Registrar Pregunta Frecuente</h6>
                </div>
