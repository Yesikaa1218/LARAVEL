...
@if($active === 0)
<form
    action="{{route('sistema.tesoreria.preguntas.approve', $id)}}"
...
<a href="{{route('sistema.tesoreria.preguntas.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.tesoreria.preguntas.destroy', ['pregunta' => $id])}}"
