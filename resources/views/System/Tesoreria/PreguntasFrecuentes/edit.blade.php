...
@section('page_name', 'Editar Pregunta Frecuente')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Editar Pregunta Frecuente</h1>
        <a href="{{route('sistema.tesoreria.preguntas.index')}}"
...
@section('content')
    <div class="container-fluid">
        <form    action="{{route('sistema.tesoreria.preguntas.update', ['pregunta' => $data->id])}}"
                 method="post">
        @method('PATCH')
        @csrf
        <!-- DataTales Example -->
