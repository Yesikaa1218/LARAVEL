...
@IF($active == 0)
<form
    action="{{route('sistema.museo.approve', $id)}}"
...
<a href="{{route('sistema.museo.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.museo.destroy', ['museo' => $id])}}"
