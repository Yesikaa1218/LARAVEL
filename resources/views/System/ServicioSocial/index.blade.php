...
@section('page_name', 'Servicio Social')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Servicio Social</h1>
    </div>
@endsection
...
@endif
        ...
        <div class="card shadow mb-4">
            ...
            <form action="{{route('sistema.servicio-social.store')}}" method="post">
                @csrf
                ...
                <div class="card-footer" align="right">
                    ...
                    <a href="{{route('sistema.preview.servicio-social.show')}}" class="btn btn-light" target="_blank">Ver preview</a>

                    @hasanyrole('SuperAdmin')
                        @if($data && $data->active === 0)
                        <form
                            action="{{route('sistema.servicio-social.approve', $data->id)}}"
