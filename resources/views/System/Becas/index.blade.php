...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Becas</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <form action="{{route('sistema.becas.store')}}" method="post">
            @csrf

            <div class="card-body">

                <div class="mb-3">
                    <label for="information" class="form-label">Divulgación de servicios</label>
                    <br>
                    <textarea id="information" name="information" class="content_page">@if($data){!! $data->information !!}@endif</textarea>
                </div>
            ...
            <div class="card-footer" align="right">
                ...
                @hasanyrole('SuperAdmin')
                    ...
                    <form 
                        action="{{route('sistema.becas.approve', $data->id)}}"
                        class="d-inline formapprove card-footer" method="POST" align="right">
                        @method('PUT')
                        @csrf
                ...
                <a href="{{route('sistema.preview.becas.show')}}" class="btn btn-light" target="_blank">Ver preview</a>
