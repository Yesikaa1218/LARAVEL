...
@IF($active == 0)
<form
    action="{{route('sistema.asesorias.profesores.approve', $id)}}"
...
<a href="{{route('sistema.asesorias.profesores.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.asesorias.profesores.destroy', ['profesore' => $id])}}"
