...
@IF($active == 0)
<form
    action="{{route('sistema.actividades-culturales.clubes.approve', $id)}}"
...
<a href="{{route('sistema.actividades-culturales.clubes.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.actividades-culturales.clubes.destroy', ['clube' => $id])}}"
