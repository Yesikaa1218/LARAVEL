...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tutorías</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <form action="{{route('sistema.tutorias.store')}}" method="post">
                @csrf
                ...
                <!-- boton aprobar -->
                    ...
                    <form
                        action="{{route('sistema.tutorias.approve', $data->id)}}"
                ...
                <a href="{{route('sistema.preview.tutorias.show')}}" class="btn btn-light" target="_blank">Ver preview</a>
