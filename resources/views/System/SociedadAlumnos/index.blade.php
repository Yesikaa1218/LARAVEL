...
@section('page_name', 'Sociedad de alumnos')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Sociedad de alumnos</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <form action="{{route('sistema.sociedad-alumnos.store')}}" method="post">
                @csrf
                <div class="card-body">
                    <div class="mb-3">
            ...
            @hasanyrole('SuperAdmin')
              @if($data && $data->active === 0)
                <form
                  action="{{route('sistema.sociedad-alumnos.approve', $data->id)}}"
            ...
            <a href="{{route('sistema.preview.sociedad-alumnos.show')}}" class="btn btn-light" target="_blank">Ver preview</a>
        </div>
