...
@section('page_name', 'Calidad Educativa')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Calidad Educativa</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <form action="{{route('sistema.calidad-educativa.informacion.store')}}" method="post">
                @csrf
                ...
                <div class="card-footer" align="right">
                    ...
                    @hasanyrole('SuperAdmin')
                        @if($data && $data->active === 0)
                            <form
                            action="{{route('sistema.calidad-educativa.approve', $data->id)}}"
                            class="d-inline card-footer formapprove" method="POST" align="right">
                                @method('PUT')
                                @csrf
                    ...
                    <a href="{{route('sistema.preview.calidadEducativa.show')}}" class="btn btn-light" target="_blank">Ver preview</a>
