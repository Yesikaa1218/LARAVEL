...
@if($active === 0)
<form
    action="{{route('sistema.facultad.profesores-emeritos.approve', $id)}}"
...
<a href="{{route('sistema.facultad.profesores-emeritos.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.facultad.profesores-emeritos.destroy', ['profesores_emerito' => $id])}}"
