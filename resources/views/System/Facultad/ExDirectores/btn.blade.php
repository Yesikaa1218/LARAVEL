...
@if($active === 0)
<form
    action="{{route('sistema.facultad.ex-directores.approve', $id)}}"
...
<a href="{{route('sistema.facultad.ex-directores.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.facultad.ex-directores.destroy', ['ex_directore' => $id])}}"
