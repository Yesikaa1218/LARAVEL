...
@section('page_name', 'Registrar Ex Director')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Registrar Ex Director</h1>
...
@section('content')
    <div class="container-fluid">
        <form action="{{route('sistema.facultad.ex-directores.store')}}" method="post"  enctype="multipart/form-data">
        @csrf
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Registrar Ex Director</h6>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-sm-12 col-mb-6 col-xl-6">
                        ...
                        <input type="date" class="form-control" id="fecha_inicio" value="{{old('fecha_inicio')}}" name="fecha_inicio" placeholder="Fecha inicial del periodo administrativo" required>
                    </div>
                    ...
                    <div class="mb-3 col-sm-12 col-mb-6 col-xl-6">
                        ...
                        <input type="date" class="form-control" id="fecha_final" value="{{old('fecha_final')}}" name="fecha_final" placeholder="Fecha final del periodo administrativo" required>
                    </div>
