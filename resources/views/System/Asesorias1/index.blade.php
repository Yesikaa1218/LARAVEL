...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Asesoría</h1>
    </div>
@endsection
...
@endif
        ...
        <div class="card shadow mb-4">
            ...
            <form action="{{route('sistema.tutorias.tutoria.store')}}" method="post">
                @csrf
                ...
                <div class="card-footer" align="right">
                    ...
                    <form
                    action="{{route('sistema.asesorias.approve', $data->id)}}"
