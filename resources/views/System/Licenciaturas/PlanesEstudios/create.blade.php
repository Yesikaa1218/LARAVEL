...
@section('content')
    <div class="container-fluid">
        <form action="{{route('sistema.licenciaturas.planes.store')}}" method="post" >
        @csrf
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name" value="{{old('name')}}" name="name" placeholder="Número del plan de estudios" required>
                </div>
