...
@section('page_name', 'Sustentabilidad')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Sustentabilidad</h1>
    </div>
@endsection
...
@endif
        ...
        <div class="card shadow mb-4">
            ...
            <form action="{{route('sistema.sustentabilidad.store')}}" method="post">
                @csrf
                ...
                @hasanyrole('SuperAdmin')
                    ...
                    <form
                        action="{{route('sistema.sustentabilidad.approve', $data->id)}}"
                ...
                <a href="{{route('sistema.preview.sustentabilidad.show')}}" class="btn btn-light" target="_blank">Ver preview</a>
