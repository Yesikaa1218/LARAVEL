...
@IF($active == 0)
<form
    action="{{route('sistema.posgrados.profesores.approve', $id)}}"
...
@endif
@endhasanyrole
<a href="{{route('sistema.posgrados.profesores.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.posgrados.profesores.destroy', ['profesore' => $id])}}"
