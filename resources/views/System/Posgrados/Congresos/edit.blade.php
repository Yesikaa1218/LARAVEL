...
@section('page_name', 'Editar Congreso de Posgrado')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Editar Congreso de Posgrado</h1>
...
@section('content')
    <div class="container-fluid">
        <form class="needs-validation"
            action="{{route('sistema.posgrados.congresos.update', ['congreso' => $data->id])}}"
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Editar Congreso de Posgrado</h6>
            </div>
