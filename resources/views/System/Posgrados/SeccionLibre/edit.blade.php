...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Editar Sección Libre de Posgrado</h1>
...
@section('content')
    <div class="container-fluid">
        <form class="needs-validation"
            action="{{route('sistema.posgrados.seccion-libre.update', $data->id)}}"
            method="post"
        ...
        <div class="card shadow mb-4"> 
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Editar Sección Libre de Posgrado</h6>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" required name="posgrado_id" id="posgrado_id">
                        ...
                        @foreach ($posgrado as $item)
                            <option value="{{$item->id}}" @if($item->id == $data->posgrado_id) selected @endif>{{$item->nombre_posgrado}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="titulo" value="{{old('titulo', $data->titulo)}}" name="titulo" placeholder="Título.">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="contenido" class="content_page" id="contenido" rows="4" placeholder="Contenido.">{{old('contenido', $data->contenido)}}</textarea>
                </div>
