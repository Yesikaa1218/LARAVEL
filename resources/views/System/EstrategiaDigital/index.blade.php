...
@section('page_name', 'Estrategia Digital')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Estrategia Digital</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <form action="{{route('sistema.estrategia-digital.store')}}" method="post">
                @csrf
            ...
            @hasanyrole('SuperAdmin')
                @if($data && $data->active === 0)
                    <form
                    action="{{route('sistema.estrategia-digital.approve', $data->id)}}"
            ...
            <a href="{{route('sistema.preview.estrategiadigital.show')}}" class="btn btn-light" target="_blank">Ver preview</a>
