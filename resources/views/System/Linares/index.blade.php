...
@section('page_name', 'Unidad Linares')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Unidad Linares</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <form action="{{route('sistema.unidad-linares.store')}}" method="post">
                @csrf
                ...
                @hasanyrole('SuperAdmin')
                    @if($data && $data->active === 0)
                        @if($data->active == 0)
                            <form
                            action="{{route('sistema.linares.approve', $data->id)}}"
