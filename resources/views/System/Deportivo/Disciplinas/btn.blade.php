...
@if($active == 0)
<form
    action="{{route('sistema.deportivo.disciplinas.approve', $id)}}"
...
<a href="{{route('sistema.deportivo.disciplinas.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.deportivo.disciplinas.destroy', ['proyecto' => $id])}}"
