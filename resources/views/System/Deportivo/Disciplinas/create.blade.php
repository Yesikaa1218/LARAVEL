...
@section('page_name', 'Registrar Disciplina Deportiva')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Registrar Disciplina Deportiva</h1>
...
@section('content')
    <div class="container-fluid">
        <form action="{{route('sistema.deportivo.disciplinas.store')}}" method="post"  enctype="multipart/form-data">
        @csrf
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Registrar Disciplina Deportiva</h6>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="mb-3 col-sm-12 col-mb-6 col-xl-6">
                        ...
                        <input type="text" class="form-control" id="nombre" value="{{old('nombre')}}" name="nombre" placeholder="Nombre de la disciplina" required>
                    </div>
                    ...
                    <div class="mb-3 col-sm-12 ">
                        ...
                        <textarea name="descripcion" class="content_page" id="descripcion" rows="4" placeholder="Descripción de la disciplina">{{old('descripcion')}}</textarea>
                    </div>
