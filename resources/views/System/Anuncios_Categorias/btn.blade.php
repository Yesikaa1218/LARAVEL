...
@IF($active == 0)
<form
    action="('sistema.avisos.categoria.approve', $id)}}"
...
<a href="{{route('sistema.avisos.categoria.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.avisos.categoria.destroy', ['avisos_categoria' => $id])}}"
