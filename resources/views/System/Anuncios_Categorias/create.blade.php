...
@section('page_name', 'Registrar Categoría del aviso')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Registrar Categoría del Aviso</h1>
...
@section('content')
    <div class="container-fluid">
        <form action="{{route('sistema.avisos.categoria.store')}}" method="post" >
        @csrf
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Registrar Categoría del Aviso</h6>
            </div>
            ...
            <div class="card-body">
              ...
              <div class="row">
                  ...
                  <div class="mb-3 col-sm-12 col-mb-6 col-xl-6">
                      ...
                      <input type="color" class="form-control" name="color" value="{{old('color')}}" id="color" placeholder="Seleccina un color">
                  </div>
              </div>
