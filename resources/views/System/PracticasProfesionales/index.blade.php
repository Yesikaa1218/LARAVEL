...
@section('page_name', 'Prácticas Profesionales')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Prácticas Profesionales</h1>
    </div>
@endsection
...
@endif
        ...
        <div class="card shadow mb-4">
            ...
            <form action="{{route('sistema.practicas-profesionales.store')}}" method="post">
                @csrf
                ...
                <div class="card-footer" align="right">
                    ...
                    <a href="{{route('sistema.preview.practicas-profesionales.show')}}" class="btn btn-light" target="_blank">Ver preview</a>

                    @hasanyrole('SuperAdmin')
                        @if($data && $data->active === 0)
                        <form
                            action="{{route('sistema.practicas-profesionales.approve', $data->id)}}"
