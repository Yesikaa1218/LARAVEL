...
@if($active === 0)
<form
    action="{{route('sistema.practicas-profesionales.preguntas.approve', $id)}}"
...
<a href="{{route('sistema.practicas-profesionales.preguntas.edit', $id)}}" class="btn btn-success btn-sm" >Editar</a>
<form
    action="{{route('sistema.practicas-profesionales.preguntas.destroy', ['pregunta' => $id])}}"
