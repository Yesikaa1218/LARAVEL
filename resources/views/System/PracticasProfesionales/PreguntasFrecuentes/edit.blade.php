...
@section('page_name', 'Editar Pregunta')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Editar Pregunta</h1>
        <a href="{{route('sistema.practicas-profesionales.preguntas.index')}}"
...
@section('content')
    <div class="container-fluid">
        <form    action="{{route('sistema.practicas-profesionales.preguntas.update', ['pregunta' => $data->id])}}"
                 method="post">
        @method('PATCH')
        @csrf
        <!-- DataTales Example -->
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label">Título de la pregunta frecuente</label>
                        <input type="text" class="form-control" id="name" value="{{old('name', $data->name)}}" name="name" placeholder="Nombre" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="content_page" class="content_page" name="content_page">{{old('content_page', $data->content_page)}}</textarea>
                    </div>
