...
@section('page_name', 'Registrar Noticia')
...
@section('page-header')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Registrar Noticia</h1>
...
@section('content')
    <div class="container-fluid">
        <form action="{{route('sistema.noticias.store')}}" method="post"  enctype="multipart/form-data">
        @csrf
        <!-- DataTales Example -->
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-sm-12 ">
                        ...
                        <textarea name="contenido" class="content_page" id="contenido" rows="4" placeholder="Contenido de la Noticia">{{old('contenido')}}</textarea>
                    </div>
