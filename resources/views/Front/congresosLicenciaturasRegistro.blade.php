        ...
        <div class="container pt-4 pb-2">
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-xl-12 col-lg-12 pt-5">
                    ...
                    <h2 class="text-center btnRegistroCongreso">Registro al congreso</h2>
                    <hr>
                    <div class="pt-5"></div>

                        <h4 class="textInstructions">Para poder registrate al congreso es necesario llenar la siguiente información <br> Los campos marcados con <span class="text-danger">*</span> son obligatorios</h4>
    ...
    $(document).ready(function() {
        ...
        $("body").on("click", '#btn_user_congreso_register', function (){
            $(".email-div").fadeOut("slow", function() {
                ...
                $.ajax({
                    url: '/congresos-user/registerLicenciatura',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        email: email_login,
                        password: password_login,
                        licenciatura_congresos_id: "{{ $data->id }}"
                    },
                    dataType: "json",
                    method: "POST",
