...
@section('pagetitle', 'Observatorio')
@section('content')
                ...
                <div class="col-xl-12 pt-5">
                    <div class="page-header__wrapper clearfix">
                        <div class="page-header__title pt-5">
                            <h2 style="text-transform: none;">Observatorio</h2>
                            <hr>
                        </div>
    ...
    <section class="desripcion-observatorio pt-5 pb-5  wow fadeInLeft animated animated"
              data-wow-delay="400ms" data-wow-duration="1500ms">
        <div class="container pt-4 pb-2">
            <div class="row justify-content-center align-items-center">
                <div class="mb-3" > 
                    <h1 align="center">
                        @if($data && $data->titulo) {!! $data->titulo !!} @endif 
                    </h1>   
                </div>
