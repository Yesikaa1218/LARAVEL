...
@section('pagetitle', 'Actividades Culturales')
@section('content')
                ...
                <div class="col-xl-12 pt-5">
                    <div class="page-header__wrapper clearfix">
                        <div class="page-header__title pt-5">
                            <h2 style="text-transform: none;">Actividades Culturales</h2>
                            <hr>
                        </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-xl-12 col-lg-12">
                    ...
                    <div class="section-title text-center">
                        <h2 class="section-title__title">Clubes Culturales</h2>
                    </div>
                                ...
                                <div class="col-sm-6 mb-3">
                                    <div class="card card-dark-mode">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text text-center">Presione el botón para ver la información del club.</p>
                                            <div class="col text-center">
                                                <a href="{{route('clubes-culturales.show', $club->slug)}}" class="btn btn-dark-mode" style="margin-left: auto; margin-right: auto;">Ver información</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
