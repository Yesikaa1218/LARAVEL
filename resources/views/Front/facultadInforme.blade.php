        ...
        <div class="container pt-4 pb-2">
            <div class="row justify-content-center align-items-center">
                <div class="col-xl-12 col-lg-12 ">
                    ...
                    <div align="center">
                        <iframe  src="/storage/{{$data->pdf}}#view=FitH" frameborder="0" style =" width: 45Vw; height: 80Vh;" ></iframe>
                    </div>
                    ...
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Presione el botón para descargar el archivo PDF con el contenido del informe.</p>
                            <a href="/storage/{{$data->pdf}}" class="btn btn-secondary" target="_blank">Descargar</a>
                        </div>
