...
Route::get('avisos', 'App\Http\Controllers\Front\HomeController@avisos')->name('avisos.show');
...
Route::get('homeEscolar', function () {
...
Route::middleware(['auth'])->prefix('sistema')->name('sistema.')->group(function () {
    ...
    Route::prefix('preview')->name('preview.')->group(function(){
        ...
        // Avisos
        Route::get('avisos', 'App\Http\Controllers\PreviewController@avisos')->name('avisos.show');
...
//MODULO ESCOLAR
    ...
    Route::get('/homeEscolar', [App\Http\Controllers\HomeSistemaEscolarController::class, 'index'])->name('homeEscolar');
...
//NOV 2023 ESCOLAR
Route::group(['middleware' => 'auth:empleado'], function () {
    Route::prefix('sistema-escolar')->name('sistema.escolar.')->group (function(){
